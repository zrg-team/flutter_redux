...
class FrostedGlassAppBar extends StatelessWidget {
  ...
  FrostedGlassAppBar(this.title, this.iconLeftButton, this.onPressLeftButton, this.iconRighButton, this.onPressRightButton);
            ...
            child: new Container(
              ...
              decoration: new BoxDecoration(
                gradient: new LinearGradient(
                  colors: [
                    AppColors.appBarGradientStart.withOpacity(0.8),
                    AppColors.appBarGradientEnd.withOpacity(0.8)
                  ],
